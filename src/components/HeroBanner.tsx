  ...
  return (
    <section className="relative overflow-hidden bg-primary text-primary-foreground">
      <div className="container py-16 md:py-24 lg:py-32">
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="space-y-6 animate-slide-in-left">
            <div className="inline-block bg-sale text-sale-foreground px-4 py-1 text-sm font-bold uppercase tracking-wider rounded">
              Zbritje deri në 70%
            </div>
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-display leading-tight">
              ZBRITJET E<br />
              <span className="text-gold">FUNDVITIT!</span>
            </h1>
          ...
          <div className="relative animate-slide-in-right hidden lg:block">
            ...
            <div className="absolute top-10 right-10 w-full h-full bg-gold/20 rounded-lg transform rotate-[5deg]"></div>
          </div>
        </div>
      </div>
      ...
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-gold/30 to-transparent"></div>
      </div>
    </section>
  );
};
